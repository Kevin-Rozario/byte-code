            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="flex items-center justify-end">
                  <Link
                    // * Change it when the forgot password page is created
                    to="/"
                    className="text-sm text-purple-400 hover:text-purple-300 transition-colors duration-200 font-medium hover:underline"
                  >
